...
#define INPUT_TS        0x00U	//No internal pull device active - Tri-State
#define INPUT_PD        0x08U	//Internal pull-down device active
#define INPUT_PU        0x10U	//Internal pull-up device active
#define INPUT_PPS       0x18U	//No internal pull device active; Pn_OUTx continuously samples the input value
#define INPUT_INV       0x20U
#define INPUT_INV_PD    0x28U
#define INPUT_INV_PU    0x30U
#define INPUT_INV_PPS   0x38U
#define OUTPUT_PP_GP    0x80U	//Push-pull - General-purpose output
#define OUTPUT_PP_AF1   0x88U	//Push-pull - Alternate output function 1
#define OUTPUT_PP_AF2   0x90U	//Push-pull - Alternate output function 2
#define OUTPUT_PP_AF3   0x98U	//Push-pull - Alternate output function 3
#define OUTPUT_PP_AF4   0xA0U	//Push-pull - Alternate output function 4
#define OUTPUT_PP_AF5   0xA8U	//Push-pull - Alternate output function 5
#define OUTPUT_PP_AF6   0xB0U	//Push-pull - Alternate output function 6
#define OUTPUT_PP_AF7   0xB8U	//Push-pull - Alternate output function 7
#define OUTPUT_OD_GP    0xC0U	//Open-drain - General-purpose output
...
__STATIC_INLINE void GPIO_set_mode(PORT0_Type* p, uint8_t mode){
    p->IOCR0 &= ~0x000000f8UL;
    p->IOCR0 |= mode << 0;
}
